...
namespace Frap3Core.BCore
{
    ...
    ///	<para>修正内容</para>
    ///	</remarks>
    public class OracleDataAccessHelper2 : AbstractDataAccessHelper
    {
        #region コンストラクタ
        ...
        public OracleDataAccessHelper2(ConnectionInfo connectInfo)
        {
        ...
        public override DbConnection GetConnection()
        {
            ...
            try
            {
                ...
                if (protocol != null)
                {
                    dbConnection = OracleUtility2.GetConnection(user, password, server, service, protocol, port);
                }
                else
                {
                    if (service.Equals(""))
                    {
                        dbConnection = OracleUtility2.GetConnection(user, password, server);
                    }
                    else
                    {
                        dbConnection = OracleUtility2.GetConnection(user, password, server, service);
                    }
                }
            }
            catch (Exception)
            ...
            OracleUtility2.OpenConnection((OracleConnection)dbConnection);
        ...
        {
            OracleUtility2.CloseConnection((OracleConnection)connection);
        }
        ...
        {
            return OracleUtility2.CreateParameter(name, (OracleDbType)this.ConvertDbType(type), direction, value);
        }
        ...
        {
            return OracleUtility2.CreateParameter(name, (OracleDbType)this.ConvertDbType(type), direction, size, value);
        }
        ...
        {
            return OracleUtility2.CreateParameter(name, (OracleDbType)this.ConvertDbType(type), direction, scale, value);
        }
        ...
        //    return OracleUtility2.CreateParameter(name, OracleType.DateTime, direction, dt);
        //}
        ///// <summary>
        ///// サーバ時間のパラメータを作成する
        ///// </summary>
